    ...
    <main className="min-h-screen bg-[#0F1419] overflow-x-hidden ">
      <section className="relative min-h-screen  flex items-center justify-center px-4 sm:px-6 lg:px-8 md:pt-8">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div
            className="absolute -top-32 -left-32 w-[480px] h-[480px] bg-[#8B5CF6]/15 rounded-full blur-[100px]"
            style={{ animation: "float 16s ease-in-out infinite" }}
          />
          <div
            className="absolute top-1/3 -right-32 w-[400px] h-[400px] bg-[#06B6D4]/12 rounded-full blur-[100px]"
            style={{ animation: "float 12s ease-in-out infinite reverse" }}
          />
          <div
            className="absolute -bottom-32 left-1/3 w-[360px] h-[360px] bg-[#10B981]/10 rounded-full blur-[100px]"
            style={{ animation: "float 20s ease-in-out infinite 4s" }}
          />
        </div>
        ...
        <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
          ...
          <div
            ...
            style={{
              ...
              boxShadow: "0 0 30px rgba(139,92,246,0.04) inset",
            }}
          />
          {/* Ring 2 */}
          <div
            ...
            style={{
              ...
              boxShadow: "0 0 25px rgba(6,182,212,0.05) inset",
            }}
          />
          {/* Ring 3 */}
          <div
            ...
            style={{
              ...
              boxShadow: "0 0 20px rgba(16,185,129,0.04) inset",
            }}
          />
          ...
          >
            <div
              className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 w-2.5 h-2.5 rounded-full bg-[#8B5CF6]"
          ...
          >
            <div
              className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 w-2 h-2 rounded-full bg-[#06B6D4]"
          ...
          >
            <div
              className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 w-1.5 h-1.5 rounded-full bg-[#10B981]"
        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            {/* Left */}
            <div className="text-center lg:text-left p-4 sm:p-6 lg:p-8">
              ...
              <p className="text-[#94A3B8] sm:text-lg leading-relaxed mb-8 max-w-lg mx-auto lg:mx-0">
                Lightning-fast real-time conversations with file sharing, read
                receipts, and typing indicators — all in one beautiful platform.
              </p>
              ...
              <div className="grid grid-cols-4 gap-4 pt-8 border-t border-[#334155]/60">
                {stats.map((s) => (
                  <div key={s.label}>
                    <p className="text-xl sm:text-2xl font-bold bg-linear-to-r from-[#8B5CF6] to-[#06B6D4] bg-clip-text text-transparent">
                      {s.value}
                    </p>
                    <p className="text-[#94A3B8] text-[10px] sm:text-xs mt-0.5 leading-tight">
                      {s.label}
                    </p>
                  </div>
                ))}
            ...
            <div className="hidden lg:block">
              <div className="relative mx-auto max-w-md">
                  ...
                  <div className="flex items-center gap-3 px-4 py-3.5 border-b border-[#334155] bg-[#0F1419]/60">
                    ...
                    <div className="flex items-center gap-2 flex-1">
                      <div className="relative shrink-0">
                        <div className="w-7 h-7 rounded-full bg-linear-to-br from-[#8B5CF6] to-[#06B6D4] flex items-center justify-center text-white font-bold text-[10px]">
                          A
                        </div>
                        <span className="absolute bottom-0 right-0 w-2 h-2 bg-[#10B981] rounded-full border border-[#1E2530]" />
                      </div>
                      <div>
                        <p className="text-[#F1F5F9] text-xs font-semibold leading-none">
                          Alice Johnson
                        </p>
                        <p className="text-[#10B981] text-[10px] mt-0.5">
                          ● Online
                        </p>
                      </div>
                    </div>
                  ...
                  <div className="px-4 py-4 flex flex-col gap-2.5">
                    <div className="flex justify-start">
                      <div className="flex items-end gap-1.5">
                        <div className="w-5 h-5 rounded-full bg-linear-to-br from-[#8B5CF6] to-[#06B6D4] flex items-center justify-center text-white font-bold text-[9px] shrink-0">
                          A
                        </div>
                ...
                <div className="absolute -top-3 -right-6 bg-[#1E2530] border border-[#334155] rounded-xl px-3 py-2 shadow-xl flex items-center gap-2">
                  <div className="w-6 h-6 rounded-full bg-[#10B981]/15 border border-[#10B981]/30 flex items-center justify-center text-[10px]">
                    🟢
                  </div>
                  <div>
                    <p className="text-[#F1F5F9] text-[10px] font-semibold leading-none">
                      Bob is online
                    </p>
                ...
                <div className="absolute -bottom-3 -left-6 bg-[#1E2530] border border-[#334155] rounded-xl px-3 py-2 shadow-xl flex items-center gap-2">
                  <div className="w-6 h-6 rounded-full bg-[#06B6D4]/15 border border-[#06B6D4]/30 flex items-center justify-center text-[10px]">
                    ✓✓
                  </div>
                  <div>
                    <p className="text-[#F1F5F9] text-[10px] font-semibold leading-none">
                    ...
                    <p className="text-[#94A3B8] text-[9px] mt-0.5">
                      2 seconds ago
                    </p>
                  </div>
                </div>
      ...
      {/* Footer */}
      <footer className="border-t border-[#334155]/60 py-6">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col sm:flex-row gap-2 items-center justify-between">
            ...
            <p className="text-[#94A3B8] text-xs">
              © {new Date().getFullYear()} LiveChat. Built for real-time
              communication.
            </p>
            <Link
              href="/about"
              className="text-[#94A3B8] hover:text-[#F1F5F9] text-xs transition-colors"
            >
